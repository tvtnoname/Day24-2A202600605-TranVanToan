...
async def check_input_rail(text: str, rails=None) -> dict:
    ...
    blocked = (not response_text.strip()) or any(kw in response_text.lower() for kw in refuse_keywords)
    return {
        "allowed":        not blocked,
...
if __name__ == "__main__":
    ...
    # Initialize rails and analyzer/anonymizer once to reuse
    rails = setup_nemo_rails()
    analyzer, anonymizer = setup_presidio()
    ...
    print(f"Adversarial suite: {passed}/{len(results)} passed ({pass_rate:.1%})")
    ...
    report_data = {
        ...
        "adversarial_total_count": len(results),
